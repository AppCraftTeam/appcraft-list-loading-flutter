...
/// Legacy default [ACSearchStrategy] implementation: debounce + minLength
...
///
/// **Deprecated**: use `ACSearchDebouncer` instead, which delegates
/// timing to the reusable `ACDebouncer`. Behaviour is identical.
@Deprecated('Will be removed in 1.0.0. Use ACSearchDebouncer instead.')
