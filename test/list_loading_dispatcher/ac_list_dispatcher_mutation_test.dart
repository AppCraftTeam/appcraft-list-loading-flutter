...
void main() {
  // -------------------------------------------------------------------------
  // US1 — external, notifying mutation via `mutate`.
  // -------------------------------------------------------------------------
  group('ACListDispatcher — mutate (US1)', () {
    ...
    test('mutate does not change lastResult', () async {
      ...
      expect(dispatcher.lastResult, equals(<int>[1, 2]));
  ...
  // -------------------------------------------------------------------------
  // US2 — manual `hasMore` control via the setter.
  // -------------------------------------------------------------------------
  group('ACListDispatcher — hasMore setter (US2)', () {
    late ACListDispatcher<_TestParams, int> dispatcher;
  ...
  // -------------------------------------------------------------------------
  // US3 — interaction with reload / loadMore / active load.
  // -------------------------------------------------------------------------
  group('ACListDispatcher — mutate/hasMore interaction (US3)', () {
    late ACListDispatcher<_TestParams, int> dispatcher;
    late FakeLoader<List<int>> loader;
